            ...
            <section className="text-gray-600 body-font relative margin">
                <motion.div {...options} className="container px-5 mx-auto flex sm:flex-nowrap flex-wrap">
                    ...
                    <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                        <motion.h2 {...options1} className="text-gray-900 text-lg text-center mb-3 font-bold title-font">Contact Us</motion.h2>
                        ...
                        <button className="text-white contactbtn border-0 py-2 px-6 focus:outline-none rounded text-lg">Send Message</button>
